...
const AlbumTracks = () => (
  <ul className="header__album__tracks album__font">
    <li style={{zIndex: 1}}>
      ...
      <span className="album__font__collapse album__font__collapse--bkgd album__font__collapse--f--a3">y</span>
    </li>
    <li>
      <span className="album__font__regular" style={{ paddingLeft: 20, marginLeft: 87 }}>
        mon
      </span>
      <span className="album__font__collapse--f album__font__collapse--bkgd">ster</span>
    </li>
    <li>
    ...
    <li>
      <span style={{ paddingLeft: 46 }}>
        ...
        <span className="album__font__collapse--f album__font__collapse--bkgd">ang</span>
    ...
    <li>
      <span style={{ paddingLeft: 84 }}>
        ...
        <span className="album__font__collapse">
          ui
          <span className="album__font__regular album__font__regular--border" style={{ marginLeft: -2 }}>
            <span className="album__font__collapse--f">l</span>
            <span className="album__font_i"></span>
            b
          </span>
