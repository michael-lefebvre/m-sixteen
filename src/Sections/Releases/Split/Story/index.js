...
import ImgLogos from '../Assets/releases_split_logos.png';
import './index.scss';
...
class ReleaseSplitStory extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (snapshot) this.setState({ isMounted: true });
  }
      ...
      >
        ...
        >
          ...
          <div className="split__story__section">
            <Image
              className="split__photo split__photo--left"
              src="split/band-1"
              width="350"
            />
            <p className="split__story__text">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
              dolor quam, dapibus sed risus eget, euismod dapibus massa. Cras
              sollicitudin auctor orci, eu sollicitudin erat viverra ut. Proin
              varius consectetur sapien id ornare. Proin a nibh eu nisi feugiat
              pretium.
            </p>
            <p className="split__story__text">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras
            ...
            <p className="split__story__text split__story__clear">
              Integer ut sodales nunc, pellentesque interdum metus. Suspendisse{' '}
              <Link to="/releases/album">Album</Link> tristique ipsum
              condimentum malesuada volutpat. Donec leo sapien, ultricies sed
              lobortis ut, tristique sed est. Cras maximus vulputate congue.
              Aenean sit amet congue dui. Integer ut consectetur tortor, at
              congue velit.
            </p>
          </div>
          <div className="split__story__section">
          ...
          <div className="split__story__section">
            <Image
              className="split__photo split__photo--right"
              src="furia/img-1"
              width="250"
            />
            ...
            <p className="split__story__text">
              Integer ut sodales nunc, pellentesque interdum metus. Suspendisse
              tristique ipsum condimentum malesuada volutpat. Donec leo sapien,
              ultricies sed lobortis ut, tristique sed est. Cras maximus
              vulputate congue. Aenean sit amet congue dui. Integer ut
              consectetur tortor, at congue velit.
            </p>
          </div>
          {/*<div className="split__story__section">
