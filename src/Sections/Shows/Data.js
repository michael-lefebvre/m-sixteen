...
const { dates, countries, cities, bands } = Data.reduce((a, c) => {
  ...
  //countries
  if(!a.countries[country])
    a.countries[country] = 1
  else
    ++a.countries[country]
...
const ListSorted = l => Object.keys(l).map(k => [k, l[k]]).sort((a, b) => b[1] - a[1] );
