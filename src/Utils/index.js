...
export const getRouteSection = (props = null ) => getRouteParams(props || defaultRouteProps).section
export const getRouteId = (props = null ) => getRouteParams(props || defaultRouteProps).id
